  (module Switch_Keyboard:SW_Alps_Matias_{{keywidth}}u (layer F.Cu) (tedit 5A02FE24) (tstamp 5E922E3E)
    (at {{x}} {{y}})
    (descr "Alps/Matias keyswitch, {{keywidth}}u, PCB mount")
    (tags "Alps Matias keyswitch {{keywidth}}u PCB")
    (path /KEYSWITCH_{{num}})
    ...
    (model ${KISYS3DMOD}/Switch_Keyboard.3dshapes/SW_Alps_Matias_{{keywidth}}u.wrl
      (at (xyz 0 0 0))
      (scale (xyz 1 1 1))
      (rotate (xyz 0 0 0))
    )
